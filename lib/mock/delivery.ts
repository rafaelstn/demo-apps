...
export const CARDAPIO: ItemCardapio[] = [
  { id: "burger", nome: "Burger da Casa", desc: "Pão brioche, 180g, cheddar e bacon", precoCentavos: 3290, categoria: "Lanches", emoji: "🍔", img: "/img/delivery/burger.jpg", tag: "Mais pedido", rating: 4.9 },
  { id: "veggie", nome: "Veggie Supreme", desc: "Grão-de-bico, queijo e salada", precoCentavos: 2990, categoria: "Lanches", emoji: "🥗", img: "/img/delivery/veggie.jpg", tag: "Novo", rating: 4.7 },
